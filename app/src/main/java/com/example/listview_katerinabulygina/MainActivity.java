package com.example.listview_katerinabulygina;
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    case 0:
                        ...
                        break;
                    case 1:
                        Intent intent1 = new Intent(MainActivity.this,Braziliay.class);
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        Intent intent3 = new Intent(MainActivity.this,Kolumbiay.class);
